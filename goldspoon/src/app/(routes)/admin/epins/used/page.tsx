...
export default function Report() {
  ...
  useEffect(() => {
    if (viewOption === "all") {
      fetchEpins('https://goldspoon.in/api/epins/used', { pageNumber: 0, pageSize: PAGE_SIZE });
    }
  }, [viewOption]);
  ...
  const getEpinByReferralId = () => {
    ...
    fetchEpins('https://goldspoon.in/api/epins/used', { memberNumber: filterId, isRefferal: true, pageNumber: 0, pageSize: PAGE_SIZE });
  };
  ...
  const getEpinByMemberId = () => {
    ...
    fetchEpins('https://goldspoon.in/api/epins/used', { memberNumber: filterId, isRefferal: false, pageNumber: 0, pageSize: PAGE_SIZE });
  };
  ...
  const handlePageChange = (event, page) => {
    ...
    if (viewOption === "all") {
      fetchEpins('https://goldspoon.in/api/epins/used', params);
