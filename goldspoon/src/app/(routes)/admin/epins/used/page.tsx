...
export default function Report() {
  ...
  useEffect(() => {
    if (viewOption === "all") {
      fetchEpins('http://localhost:8080/api/epins/used', { pageNumber: 0, pageSize: PAGE_SIZE });
    }
  }, [viewOption]);
  ...
  const getEpinByReferralId = () => {
    ...
    fetchEpins('http://localhost:8080/api/epins/used', { memberNumber: filterId, isRefferal: true, pageNumber: 0, pageSize: PAGE_SIZE });
  };
  ...
  const getEpinByMemberId = () => {
    ...
    fetchEpins('http://localhost:8080/api/epins/used', { memberNumber: filterId, isRefferal: false, pageNumber: 0, pageSize: PAGE_SIZE });
  };
  ...
  const handlePageChange = (event, page) => {
    ...
    if (viewOption === "all") {
      fetchEpins('http://localhost:8080/api/epins/used', params);
